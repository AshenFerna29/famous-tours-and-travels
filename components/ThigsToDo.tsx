...
const LOCATIONS: Location[] = [
  ...
  },
  {
    ...
    y: 68,
    excerpt:
      "Hill-country village for Ella Rock, Nine Arches Bridge & Ravana Falls.",
  },
  {
    id: 12,
    name: "Mirissa",
    ...
    x: 51,
    y: 78,
    excerpt: "South-coast bay with whale watching and Coconut Tree Hill.",
  },
  {
    id: 13,
    name: "Dambulla",
    ...
    x: 55,
    y: 46,
    excerpt: "UNESCO cave temples filled with gilded Buddhas and murals.",
  },
  {
    id: 14,
    name: "Bentota",
    ...
    x: 33,
    y: 71,
    excerpt: "Golden beaches and watersports on the Bentota River.",
  },
  {
    id: 15,
    name: "Hikkaduwa",
    ...
    x: 36,
    y: 73,
    excerpt: "Coral sanctuary, mellow surf, and turtle hatcheries.",
  },
  {
    id: 16,
    name: "Wilpattu",
    ...
    y: 28,
    excerpt:
      "Sri Lanka’s largest park—leopards, lakes (villus), and quiet safaris.",
  },
  {
    id: 17,
    name: "Wasgamuwa",
    ...
    x: 60,
    y: 50,
    excerpt: "Low-key national park with elephants and rich birdlife.",
  },
  {
    id: 18,
    name: "Sinharaja",
    ...
    x: 45,
    y: 67,
    excerpt: "UNESCO rainforest—endemic flora, frogs, and superb birding.",
  },
  {
    id: 19,
    name: "Udawalawe",
    ...
    x: 64,
    y: 70,
    excerpt: "Open landscapes and large elephant herds—classic safari.",
  },
  {
    id: 20,
    name: "Pinnawala",
    ...
    x: 44,
    y: 56,
    excerpt: "Elephant Orphanage with riverside viewing and feeding times.",
  },
];
